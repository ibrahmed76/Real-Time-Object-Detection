...
class SmartRoomMonitor:
    ...
    def process_frame(self, frame: np.ndarray) -> Tuple[np.ndarray, Dict[str, int]]:
        ...
        # Initialize behaviors at the start
        behaviors = {
            'total': 0,
            'standing': 0,
            'sitting': 0,
        ...
        for result in yolo_results:
            ...
            for box in boxes:
                ...
                # Check for both 'cell phone' and 'phone' class names
                elif class_name in ['cell phone', 'phone']:
                    phone_boxes.append((x1, y1, x2, y2))
                    behaviors['using_phone'] += 1
                    # Draw phone bounding box in blue
        ...
        # Update total count based on combined detections
        behaviors['total'] = len(combined_detections)
